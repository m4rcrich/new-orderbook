...
module perpetual_v3::clearing_house {
    ...
    fun settle_liquidated_position<T0>(arg0: &mut ClearingHouse<T0>, arg1: &LiquidationReceipt, arg2: u256, arg3: u256, arg4: u256, arg5: u64, arg6: u64, arg7: &sui::object::ID) : (u256, u256, u256, u256, u256, bool) {
        ...
        if (!v28) {
            let (v31, v32) = compute_and_set_tolerance_diff(perpetual_v3::market::get_liquidation_tolerance(v0), v7, v10, arg3, v3, v4, v5, true, v19);
        ...
        perpetual_v3::events::emit_liquidated_position(*arg7, arg1.liqee_account_id, arg6, true, v18, v10, v25, perpetual_v3::position::get_collateral(v11), v33, v34, v26);
        (v24, v22, v26, v19, v20, true)
    }
